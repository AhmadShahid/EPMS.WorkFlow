namespace EPMS.WorkFlow.Core.Migrations
{
    ...
    public partial class EPMS_Workflow : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        RequestReason = c.String(nullable: false, maxLength: 500),
                        CreatedOn = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
            
            CreateTable(
                "dbo.MaintenanceWorklists",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MaintenanceWorklists", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.MaintenanceWorklists", "MaintenanceRequestId", "dbo.MaintenanceRequests");
            ...
            DropIndex("dbo.MaintenanceWorklists", new[] { "User_Id" });
            DropIndex("dbo.MaintenanceWorklists", new[] { "MaintenanceRequestId" });
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.AspNetUserRoles");
            DropTable("dbo.AspNetUserLogins");
            DropTable("dbo.AspNetUserClaims");
            DropTable("dbo.AspNetUsers");
            DropTable("dbo.MaintenanceWorklists");
